...
- LONG FADE when: return < -2.0% AND volume > 2.0× avg (exhaustion selloff)
- SHORT FADE when: return > +2.0% AND volume > 2.0× avg (exhaustion rally)
