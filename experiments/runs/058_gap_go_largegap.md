...
- Gap-up: today_open > prev_close × (1 + 1.0/100)
- Skip gaps > 4.0% (earnings/news blowups)
- At 9:45 ET: if price still above 50% of gap → gap is held
- Session filter: SPY above VWAP AND up >0.5% from open
